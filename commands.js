...
text += 'Ispirato al bot di Quinella e TalkTakesTime, modificato ed aggiornato da The Chaos, un ringraziamento speciale a Legit Button per l\'hosting sul suo server e a Great Man per il debugging';
this.say(con, room, text);
},
